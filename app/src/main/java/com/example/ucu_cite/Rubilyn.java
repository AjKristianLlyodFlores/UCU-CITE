...
public class Rubilyn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mess13.setText(Html.fromHtml("<a href=\"mailto:rubilynnonales@ucu.edu.ph\"> rubilynnonales@ucu.edu.ph</a>"));
    ...
    public void previous12(View view) {
        Intent intent = new Intent(Rubilyn.this, Consultation.class);
